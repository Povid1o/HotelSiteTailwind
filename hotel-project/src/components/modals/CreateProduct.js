...
const CreateProduct = observer(() => {
  ...
  return (
    ...
    <form className="= text-md text-center py-8 ">
      Добавьте изображение:<input ref={fileInputRef} onChange={selectFile} type='file'  className='ml-2 outline outline-1 outline-main_theme rounded-lg '/>
    </form>
    <hr/>
    ...
    <h3 className="text-lg font-semibold font-sans text-center pt-4 mb-2">Добавить Описание:</h3>
        ...
        <div>
          ...
          <form className="= text-md text-center py-8 ">
            Добавьте изображение:<input type='file' className='ml-2 outline outline-1 outline-main_theme rounded-lg '/>
          </form><hr/>
          <form className="= text-md text-center py-8 ">
            Добавьте изображение:<input type='file' className='ml-2 outline outline-1 outline-main_theme rounded-lg '/>
          </form><hr/>
